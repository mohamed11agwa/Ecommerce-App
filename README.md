...
full-featured e-commerce platform with user authentication, role-based access (user/ seller/ admin),
product browsing and management, shopping cart with online payments, and an admin dashboard for managing orders,
users, and products.
